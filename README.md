...
- **🧵 Hacker News Discussions** — HN-style feeds get live points and comment counts, nested comments fetched directly by each reader's device, coverage-aware AI discussion summaries, Q&A, and editable comment/reply drafting
